...
form.write("Use this form to update the *tenant*, *tail number*, and *type of aircraft* in each hangar.")
form.write('**To clear a hangar**, enter in the Hangar ID, leave the rest of the fields blank, and click "Update Hangar Info"')
form.write('**To display the hangar chart and data table** without changing data, leave all fields blank and click "Update Hangar Info"')
form.write("Click the sidebar on the left for additional tools.")
form.write("*Note: Longer names may need to be abbreviated to fit*")
hangarId = form.text_input("Enter the Hangar ID of the hangar you would like to modify:")
